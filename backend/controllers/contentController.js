  ...
  try {
    ...
    if (!content) {
      content = new Content({
        ...
        catalogueUrl: "/Florinaa-catalogue.pdf",
        aboutText:
          "Florinaa - Sleep in Style brings textile manufacturing discipline into a warmer, more design-led home lifestyle brand. From Panipat to premium homes, every piece is designed around softness, durability, and dependable finishing.",
        facilityImages: [
