...
const App = () => {
  ...
  const [downloadForm, setDownloadForm] = useState({ name: "", email: "", phone: "" });
  ...
  const leadMutation = useMutation({
    ...
    onError: (error) => {
      setFormError(error.response?.data?.error || "Failed to submit request. Please try again.");
    },
  });
              ...
              {!downloadSuccess ? (
                <>
                  <div className="text-center mb-6">
                    ...
                    <h3 className="font-serif text-2xl text-primary font-medium">Download Catalogue</h3>
                    <p className="text-sm text-neutral-600 mt-2">
                      Please enter your contact details to gain access to our premium collections catalogue.
                    </p>
                  </div>
                  ...
                  <form onSubmit={handleDownloadSubmit} className="space-y-4">
                    ...
                    >
                      {leadMutation.isPending ? "Generating Access..." : "Download Now"}
                    </button>
                  </form>
                </>
              ) : (
                <div className="text-center py-8">
                  ...
                  <h3 className="font-serif text-2xl text-primary font-medium">Thank You!</h3>
                  <p className="text-sm text-neutral-600 mt-2">
